...
package co.cask.common.util.internal.io;
...
import co.cask.common.util.internal.asm.ClassDefinition;
import co.cask.common.util.internal.asm.Methods;
import co.cask.common.util.internal.asm.Signatures;
...
//  private String className;
   ...
   * @return A {@link co.cask.common.util.internal.asm.ClassDefinition} that contains generated class information.
   */
...
//    co.cask.cdap.internal.asm.Debugs.debugByteCode(classDefinition, new java.io.PrintWriter(System.out));
   ...
   * {@link #getCallTypeToken(com.google.common.reflect.TypeToken, co.cask.cdap.internal.io.Schema)}.
  ...
  /**
   * Returns the method for calling {@link co.cask.cdap.internal.io.FieldAccessor} based on the data type.
   * @param type Data type.
   * @return A {@link org.objectweb.asm.commons.Method} for calling {@link co.cask.cdap.internal.io.FieldAccessor}.
   */
  ...
  /**
   * Generates the name of the class field for storing {@link co.cask.cdap.internal.io.FieldAccessor} for the given
   * record field.
