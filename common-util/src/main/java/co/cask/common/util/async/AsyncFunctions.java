 ...
 * the License.
 */
package co.cask.common.util.async;
...
/**
 * Static utility methods for operating with {@link com.google.common.util.concurrent.AsyncFunction}.
 */
public final class AsyncFunctions {

  /**
   * Converts a {@link com.google.common.base.Function} into {@link com.google.common.util.concurrent.AsyncFunction} by
   * performing the operation in the given executor.
   *
   * @param function Function to apply
   * @param executor Executor for the function to execute in
   * @param <I> Input type
   * @param <O> Output type
   * @return A {@link com.google.common.util.concurrent.AsyncFunction} that will call the function in the given
   *        executor.
   */
  ...
  /**
   * Converts a {@link com.google.common.base.Function} into {@link com.google.common.util.concurrent.AsyncFunction} by
   * performing the operation in the same thread.
   *
   * @param function Function to apply
   * @param <I> Input type
   * @param <O> Output type
   * @return A {@link com.google.common.util.concurrent.AsyncFunction} that will call the function in the same thread
