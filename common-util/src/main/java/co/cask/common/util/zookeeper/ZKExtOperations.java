 ...
 * the License.
 */
package co.cask.common.util.zookeeper;

import co.cask.common.io.Codec;
import co.cask.common.util.async.AsyncFunctions;
...
public final class ZKExtOperations {
   ...
   * exists ({@link org.apache.zookeeper.KeeperException.NodeExistsException}), the node will be set with the given
   * content. This method is suitable for cases where the node expected to be non-existed.
   *
   ...
   * @return A {@link com.google.common.util.concurrent.ListenableFuture} that will be completed when node is created
   *        or data is set. The future will fail if failed to create and to set the data. Calling
   *        {@link com.google.common.util.concurrent.ListenableFuture#cancel(boolean)} has no effect.
   */
   ...
   * ({@link org.apache.zookeeper.KeeperException.NoNodeException}), a persistent node will be created with the given
   * content. This method is suitable for cases where the node is expected to be existed.
   *
   * @param zkClient The ZKClient to perform the operations.
   * @param path The path in ZK.
   * @param data The content of the ZK node.
   ...
   *
   * {@link #updateOrCreate(org.apache.twill.zookeeper.ZKClient, String, com.google.common.base.Function, Codec,
   * java.util.List)
   * updateOrCreate(zkClient, path, modifier, codec, null)}
   *
   * @see #updateOrCreate(org.apache.twill.zookeeper.ZKClient, String, com.google.common.base.Function, Codec,
   * java.util.List)
   */
   ...
   *
   * @see #updateOrCreate(org.apache.twill.zookeeper.ZKClient, String, com.google.common.util.concurrent.AsyncFunction,
   * Codec, java.util.List)
   */
  public static <V> ListenableFuture<V> updateOrCreate(ZKClient zkClient, String path,
                                                       Function<V, V> modifier, Codec<V> codec,
   ...
   * Update the content of the given node. If the node doesn't exists, it will try to create the node. Same as calling
   *
   * {@link #updateOrCreate(org.apache.twill.zookeeper.ZKClient, String,
   * com.google.common.util.concurrent.AsyncFunction, Codec, java.util.List)
   * updateOrCreate(zkClient, path, modifier, codec, null)}
   *
   * @see #updateOrCreate(org.apache.twill.zookeeper.ZKClient, String, com.google.common.util.concurrent.AsyncFunction,
   * Codec, java.util.List)
   ...
   * @return A {@link com.google.common.util.concurrent.ListenableFuture} that will be completed when node is created
   *         or data is set. The future will carry the actual content being set into the node. The future will fail if
   *         failed to create and to set the data. Calling
   *         {@link com.google.common.util.concurrent.ListenableFuture#cancel(boolean)} has no effect.
   */
  public static <V> ListenableFuture<V> updateOrCreate(ZKClient zkClient, String path,
                                                       AsyncFunction<V, V> modifier, Codec<V> codec,
   ...
   * either {@link org.apache.twill.zookeeper.ZKClient#create(String, byte[], org.apache.zookeeper.CreateMode)} or
   * {@link org.apache.twill.zookeeper.ZKClient#setData(String, byte[])} wil be called first.
   *
   * @param zkClient The ZKClient to perform the operations.
   * @param path The path in ZK.
   * @param data The content of the ZK node.
   ...
   * {@link #updateOrCreate(org.apache.twill.zookeeper.ZKClient, String, com.google.common.base.Function, Codec,
   * java.util.List)}. If the creation failed with {@link org.apache.zookeeper.KeeperException.NodeExistsException},
   * the {@link #getAndSet(org.apache.twill.zookeeper.ZKClient, String, com.google.common.util.concurrent.AsyncFunction,
   * Codec, com.google.common.util.concurrent.SettableFuture, java.util.List)} will be called.
   */
