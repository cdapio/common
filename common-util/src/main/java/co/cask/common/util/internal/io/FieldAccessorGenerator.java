...
import co.cask.cdap.internal.io.AbstractFieldAccessor;
...
/**
 * Generate a class bytecode that implements {@link co.cask.cdap.internal.io.FieldAccessor} for a given class field.
 * The generated class extends from {@link co.cask.cdap.internal.io.AbstractFieldAccessor} and overrides the
 * {@link co.cask.cdap.internal.io.AbstractFieldAccessor#get(Object)} and
 * {@link co.cask.cdap.internal.io.AbstractFieldAccessor#set(Object, Object)} methods. The primitive getter/setter
 * will be overridden as well if the field it tries to access is of primitive type.
 *
