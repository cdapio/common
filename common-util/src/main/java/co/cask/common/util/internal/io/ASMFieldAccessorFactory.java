...
/**
 * A {@link FieldAccessorFactory} that uses ASM to generate a specific {@link co.cask.cdap.internal.io.FieldAccessor}
 * class for each field. The resulting {@link co.cask.cdap.internal.io.FieldAccessor} instance will be cached and
 * reused.
 */
public final class ASMFieldAccessorFactory implements FieldAccessorFactory {
  ...
  /**
   * The {@link com.google.common.cache.CacheLoader} for generating instance of
   * {@link co.cask.cdap.internal.io.FieldAccessor} instance.
   */
