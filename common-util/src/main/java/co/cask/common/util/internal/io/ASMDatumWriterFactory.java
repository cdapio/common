...
import co.cask.common.util.internal.asm.ByteCodeClassLoader;
import co.cask.common.util.internal.asm.ClassDefinition;
import co.cask.common.util.lang.ClassLoaders;
...
public final class ASMDatumWriterFactory implements DatumWriterFactory {
  ...
  /**
   * Creates a {@link DatumWriter} that is able to encode given data type with the given
   * {@link co.cask.cdap.internal.io.Schema}. The instance created is thread safe and reusable.
   *
