...
public final class Signatures {
   ...
   * @param types List of {@link com.google.common.reflect.TypeToken} that matches with the number of arguments in
   *              the given method. For a given method argument, if the coresponding
   *              {@link com.google.common.reflect.TypeToken} is non-null, it will be used to generate the
