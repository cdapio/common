...
public abstract class AuthorizationProxyFactory {
  ...
  @Inject
  public AuthorizationProxyFactory(AuthorizationClient authorizationClient) {
  ...
  protected void verifyAuthorized(ObjectId objectId,
                                  Set<String> requiredPermissions) throws IOException {
    authorizationClient.authorizeCurrentUser(objectId, requiredPermissions);
  }
}
