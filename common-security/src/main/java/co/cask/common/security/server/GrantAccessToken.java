...
public class GrantAccessToken {
  ...
  public GrantAccessToken(TokenManager tokenManager,
                          ...
                          SecurityConfiguration cSecurityConfiguration) {
    this.tokenManager = tokenManager;
    this.tokenCodec = tokenCodec;
    this.cConf = cSecurityConfiguration;
    this.tokenExpiration = cConf.getLong(Constants.TOKEN_EXPIRATION);
    this.extendedTokenExpiration = cConf.getLong(Constants.EXTENDED_TOKEN_EXPIRATION);
  }
