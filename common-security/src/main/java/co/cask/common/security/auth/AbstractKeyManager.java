...
public abstract class AbstractKeyManager extends AbstractIdleService implements KeyManager {
   ...
   * @throws java.security.InvalidKeyException If the input {@code keyId} does not match a known key or the key is not
   * accepted by the internal {@code Mac} implementation.
   */
