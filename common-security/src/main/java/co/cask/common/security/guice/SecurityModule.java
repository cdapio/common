...
public abstract class SecurityModule extends PrivateModule {
  ...
  @Provides
  private Class<? extends Handler> provideHandlerClass(SecurityConfiguration configuration)
    throws ClassNotFoundException {
    return configuration.getClass(Constants.AUTH_HANDLER_CLASS, null, Handler.class);
  }
